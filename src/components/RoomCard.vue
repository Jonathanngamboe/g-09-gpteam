<template>
    <q-card flat bordered>
      <!-- Room image -->
      <img
        :src="room.images && room.images.length > 0 ? (room.images_url || room.images[0].ext_url) : 'https://www.trojanpress.com.au/wp-content/uploads/2019/05/Image-Coming-Soon-02-1024x683.jpg'"
        alt="Room image"
      />
